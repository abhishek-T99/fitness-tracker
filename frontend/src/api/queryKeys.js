...
export const qk = {
  ...
  workouts: {
    ...
    overloadStreaks: ()             => ["overloadStreaks"],
    rpeTrend:        (days)         => ["rpeTrend", days],
    durationTrend:   (weeks)        => ["durationTrend", weeks],
    sessionDensity:  (weeks)        => ["sessionDensity", weeks],
    cardioSummary:   (days)         => ["cardioSummary", days],
    dowHeatmap:      (weeks)        => ["dowHeatmap", weeks],
    muscleBalance:   (weeks)        => ["muscleBalance", weeks],
  },
  routines: {
    all:    ()       => ["routines"],
